...
namespace Chameleon{
     ...
     */
    static int pieceValue[6] = {100, 300, 300, 500, 900, 99999};

    //Values taken from PeSTO's evaluation function
    //https://www.chessprogramming.org/PeSTO%27s_Evaluation_Function
    static int pcSqTablesMiddle[6][64] = {
            { //PAWNS
                    0,   0,   0,   0,   0,   0,  0,   0,
